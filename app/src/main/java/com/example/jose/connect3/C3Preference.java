...
public class C3Preference extends Activity {
    ...
    public final static String PLAYER_NAME_KEY = "playername"; public final static String PLAYER_NAME_DEFAULT = "unspecified"; public final static String FIGURE_NAME_KEY = "figurename"; public final static String FIGURE_NAME_DEFAULT = "completo"; public final static String FIGURE_CODE_KEY = "figurecode"; public final static String FIGURE_CODE_DEFAULT =
    ...
    public static void setFigureName(Context context, String figurename) {
        ...
        SharedPreferences.Editor editor = sharedPreferences.edit(); editor.putString(C3Preference.FIGURE_NAME_KEY, figurename); editor.commit();
    }
